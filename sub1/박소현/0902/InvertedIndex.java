...
public class InvertedIndex {
	...
	*/
	//this class's result will be 'filename : offset'.So, output type should be a Text type.
	public static class TokenizerMapper
		...
		protected void setup(Context context) throws IOException, InterruptedException {
			//NOTE
			//get a filename which is currently used.
		...
		public void map(Object key, Text value, Context context)
			...
			//NOTE
			//get a offset(which is first input word's first char location in the whole file.)
			//It meeans we should calculate next word's offset by ourselves until at the end of the input file.
			...
			while ( itr.hasMoreTokens() ) {
				...
				if(! token.equals(" ")) {
					//NOTE
					//combine filename and current location.
					pos.set(filename+":"+p);
					context.write(word, pos);
				}
				//NOTE
				//get a length of token.
				p += token.length();
			}
		}
	}
	...
	*/
	...
	public static void main(String[] args) throws Exception {
		...
		//NOTE
		// automatically delete output dir
