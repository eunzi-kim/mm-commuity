...
public class Driver {
	public static void main(String[] args) {
		...
		try {
			pgd.addClass("wordcount1char", Wordcount1char.class, "A map/reduce program that counts the 1st character of word in the input files.");	
			pgd.addClass("wordcount",Wordcount.class, "A map/reduce program that counts the words in the input files.");
			pgd.addClass("wordcountsort", Wordcountsort.class, "A map/reduce program that output frequency of the word in the input files by alphabetical order.");
