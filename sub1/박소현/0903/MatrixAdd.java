...
public class MatrixAdd {
  public static class MAddMapper  extends  Mapper<Object, Text, Text , IntWritable>{
	...
	//NOTE
	//split input data by a tab key and put into array	
	String[] arr = value.toString().split("\t");

	//NOTE
	//arr[0] is A or B.
	//Only arr[1] and arr[2] has a location, and then arr[3] has a value. Check 'matadd-data-2x2.txt'.
	//So, put a location into emitkey value.
