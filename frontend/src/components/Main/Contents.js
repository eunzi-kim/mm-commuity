...
class Contents extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      "Group": ["5기 계절학기(지역)", "5기 광주 1반", "광주&구미 - 문제출제대회", "싸피레이스 그룹 4(광주)", "개인 메시지"],
      // 채널 dict 정리할 때, 비공개 채널은 자물쇠 표시!!
      "Channel": {
        "5기 계절학기(지역)": ["공지사항", "잡담", "Q&A", "Q&A(자기주도 PJT)", "🔒광주 1반"],
        "5기 광주 1반": ["1. SW 스타트 캠프", "2. 온라인 코칭", "공지사항", "이벤트", "일타싸피", "잡담", "종강식 이벤트", "BGM", "🔒5미자차", "🔒광주1반 거북컴들"],
        "광주&구미 - 문제출제대회": ["공지사항", "Q&A"],
        "싸피레이스 그룹 4(광주)": ["공지사항", "수다방", "팀구성:D", "QnA"],
